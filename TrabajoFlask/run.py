...
#Ruta por defecto, antes de mostrar la vista verificara la base de datos
...
#Maneja la eliminacion de la tarea de la base de datos, por id.
...
#Actualiza el campo marcado de la base de datos que hara que en la vista esta tarea se tache.
